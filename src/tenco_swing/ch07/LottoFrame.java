...
public class LottoFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		repaint(); // 다시 그림을 그리라 요청하는 명렁어 // F5
	...
	public void paint(Graphics g) {
		...
		int[] getNumber = lottoRandomNumber.creatNumber();
		
		
		if(isStart) {
			g.drawString("로또 번호를 클릭하세요", 190, 200);			
		}else {			
			for(int i = 0; i<6; i++) {
				g.drawString(getNumber[i] + " ", 150 + i*NUMBER_DISTANCE , 200);			
			}
		}
