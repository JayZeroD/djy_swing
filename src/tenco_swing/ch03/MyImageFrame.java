...
public class MyImageFrame extends JFrame{
	...
	static class MyImagePanel extends JPanel{
		...
		public MyImagePanel() {
			...
			image1 = new ImageIcon("라이언배.png").getImage();
			image2 = new ImageIcon("image1.png").getImage();
			image3 = new ImageIcon("runningman.gif").getImage();
		}
		
		// paints X , prints X , paint O
		@Override
		public void paint(Graphics g) {
			super.paint(g);
			g.drawImage(image1, 100, 100, 300, 300, null);
			g.drawImage(image2, 300, 50, 100, 100, null);
			g.drawImage(image3, 400, 400, 100, 100, this);
		}
